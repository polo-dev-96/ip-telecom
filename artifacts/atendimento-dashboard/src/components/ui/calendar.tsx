  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_middle: cn(
          "bg-primary/20 text-foreground rounded-none hover:bg-primary/30",
        ...
        today: cn(
          "bg-accent/50 text-accent-foreground rounded-md data-[selected=true]:rounded-none font-bold",
